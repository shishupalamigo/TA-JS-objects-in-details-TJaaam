...
outerFn()(); // ReferenceError: innerItem is not defined at outerFn
...
let object = {
  ...
  dataDouble: [1, 2, 3],
  double: function () {
    console.log('this inside of outerFn double()'); // this inside of outerFn double()
  ...
  doubleArrow: function () {
    ...
    return this.dataDouble.map((item) => {
      console.log(this); // object 3 times
      return item * 2;
    });
  },
};
